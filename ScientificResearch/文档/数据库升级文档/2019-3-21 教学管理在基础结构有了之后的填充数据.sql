...
VALUES  ( 1 , 0 ,1 ,1 , N'教学办公' , N'' ,N'' , 1 ,N'' ,N''),
			...
			(201,2,2,1,N'请假审核',N'',N'',1,N'',N'学员的申请请假和请假一览在另一个系统,这里只有老师们的审核管理;学员申请请假都可以放在具体的轮转图形里面,打回后修改申请不行.'), 
		...
		(3,0,1,3,N'培训管理',N'',N'',1,N'',N''), 
			...
			(310,3,2,10,N'学员入科',N'',N'',1,N'',N'属于科室管理员.学员科室报到及带教老师安排;选择带教老师时,带教老师当前带了几个学生还做了提示;'), 
		...
		(8,0,1,8,N'系统设置',N'',N'',1,N'',N''), 
			...
			(804,8,2,4,N'培训设置',N'',N'',1,N'',N''), 
				(80401,804,3,1,N'标准培训专业设置',N'',N'',1,N'',N'标准规培专业配置,年份作为一个属性.而不是每年不同的专业配置'), 
				(80402,804,3,2,N'标准规培科室设置',N'',N'',1,N'',N'属于哪个标准培训专业,基本信息,任务'), 
				(80403,804,3,3,N'教学策略',N'',N'',1,N'',N'比如本科实习生培训策略这样的,一个策略+一个专业,对应多个本院科室轮转安排.'), 
