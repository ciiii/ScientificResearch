...
VALUES  ( 1, 0, 1, 1, N'教学办公', N'', N'', 1, N'office', N'' ),
        ...
        ( 416, 4, 2, 16, N'带教老师对科室管理员', N'evaluate360?from=4&to=3', N'', 1,
          N'', N'' ),
		  ( 417, 4, 2, 17, N'评价查询', N'evaluateQuery', N'', 1,
          N'', N'' ),
        ...
        ( 5, 0, 1, 5, N'教学活动', N'', N'', 1, N'teachingActivities', N'' ), 
			...
			--至于学员,是否可以只有手机端?
        ( 502, 5, 2, 2, N'小讲课', N'activities?type=1', N'', 1, N'', N'' ),
        ( 503, 5, 2, 3, N'大讲课', N'activities?type=2', N'', 1, N'', N'' ),
        ( 504, 5, 2, 4, N'教学查房', N'activities?type=3', N'', 1, N'', N'' ),
        ( 505, 5, 2, 5, N'入科教育', N'activities?type=4', N'', 1, N'', N'' ),
        ( 506, 5, 2, 6, N'岗前培训', N'activities?type=5', N'', 1, N'', N'' ),
        ( 507, 5, 2, 7, N'病例讨论', N'activities?type=6', N'', 1, N'', N'' ),
        ( 508, 5, 2, 8, N'技能训练', N'activities?type=7', N'', 1, N'', N'' ), 
        ( 509, 5, 2, 9, N'教学活动查询', N'activitiesQuery', N'', 1, N'', N'' ), 
