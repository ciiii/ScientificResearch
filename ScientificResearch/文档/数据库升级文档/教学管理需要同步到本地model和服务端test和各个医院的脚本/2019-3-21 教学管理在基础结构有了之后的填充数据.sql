...
VALUES  ( 1, 0, 1, 1, N'教学办公', N'', N'', 1, N'office', N'' ),
        ...
        ( 303, 3, 2, 3, N'学员报到', N'studentReport', N'', 1, N'', N'' ),
        ( 304, 3, 2, 4, N'学员宿舍安排', N'dormitoryArrangement', N'', 1, N'', N'' ), 
			--学员轮转管理是这里的核心,主要的操作有:
        ...
        ( 305, 3, 2, 5, N'学员轮转管理', N'studentRotationManage', N'', 1, N'', N'' ),
        ( 306, 3, 2, 6, N'学员补轮转', N'repairRotation', N'', 1, N'', N'' ),
        ( 307, 3, 2, 7, N'学员退培', N'retireTraining', N'', 1, N'', N'' ),
        ( 308, 3, 2, 8, N'学员考试成绩', N'testScores', N'', 1, N'', N'' ),
        ( 309, 3, 2, 9, N'医疗差错及事故记录', N'medicalErrorRecord', N'', 1, N'', N'' ),
        ( 310, 3, 2, 10, N'学员入科', N'studentEntry', N'', 1, N'',
          N'属于科室管理员.学员科室报到及带教老师安排;选择带教老师时,带教老师当前带了几个学生还做了提示;' ),
        ( 311, 3, 2, 11, N'更换带教老师', N'changeTeacher', N'', 1, N'', N'' ),
        ( 312, 3, 2, 12, N'考勤', N'signIn', N'', 1, N'', N'' ),

		--
        ( 4, 0, 1, 4, N'360评价', N'', N'', 1, N'360Evaluate', N'' ), 
		--大家分角色拥有的:
        ( 404, 4, 2, 4, N'学员互评', N'evaluate360?from=0&to=0', N'', 1, N'', N'' ),
        ( 405, 4, 2, 5, N'学员对医院管理员', N'evaluate360?from=0&to=2', N'', 1, N'',
          N'' ),
        ( 406, 4, 2, 6, N'学员对科室管理员', N'evaluate360?from=0&to=3', N'', 1, N'',
          N'' ),
        ( 407, 4, 2, 7, N'学员对带教老师', N'evaluate360?from=0&to=4', N'', 1, N'', N'' ),
        ( 408, 4, 2, 8, N'医院管理员对学员', N'evaluate360?from=2&to=0', N'', 1, N'',
          N'' ),
        ( 409, 4, 2, 9, N'医院管理员对科室管理员', N'evaluate360?from=2&to=3', N'',
          1, N'', N'' ),
        ( 410, 4, 2, 10, N'医院管理员对带教老师', N'evaluate360?from=2&to=4', N'', 1, N'',
          N'' ),
        ( 411, 4, 2, 11, N'科室管理员对学员', N'evaluate360?from=3&to=0', N'', 1, N'',
          N'' ),
        ( 412, 4, 2, 12, N'科室管理员对医院管理员', N'evaluate360?from=3&to=2',
          N'', 1, N'', N'' ),
        ( 413, 4, 2, 13, N'科室管理员对带教老师', N'evaluate360?from=3&to=4', N'', 1,
          N'', N'' ),
        ( 414, 4, 2, 14, N'带教老师对学员', N'evaluate360?from=4&to=0', N'', 1, N'', N'' ),
        ( 415, 4, 2, 15, N'带教老师对医院管理员', N'evaluate360?from=4&to=2', N'', 1, N'',
          N'' ),
        ( 416, 4, 2, 16, N'带教老师对科室管理员', N'evaluate360?from=4&to=3', N'', 1,
          N'', N'' ),
		  ( 417, 4, 2, 17, N'评价查询', N'', N'', 1,
          N'', N'' ),
		  ( 418, 4, 2, 18, N'对我的评价', N'teacherToDepartmentAdmin', N'', 1,
          N'', N'' ),
        ...
        ( 5, 0, 1, 5, N'教学活动', N'', N'', 1, N'teachingActivities', N'' ), 
			...
			--至于学员,是否可以只有手机端?
        ( 502, 5, 2, 2, N'小讲课', N'smallLecture', N'', 1, N'', N'' ),
        ( 503, 5, 2, 3, N'大讲课', N'bigLecture', N'', 1, N'', N'' ),
        ( 504, 5, 2, 4, N'教学查房', N'teachingWardRound', N'', 1, N'', N'' ),
        ( 505, 5, 2, 5, N'入科教育', N'entranceEducation', N'', 1, N'', N'' ),
        ( 506, 5, 2, 6, N'岗前培训', N'jobTraining', N'', 1, N'', N'' ),
        ( 507, 5, 2, 7, N'病例讨论', N'caseDiscuss', N'', 1, N'', N'' ),
        ( 508, 5, 2, 8, N'技能训练', N'skillTraining', N'', 1, N'', N'' ), 
        ( 509, 5, 2, 9, N'教学活动查询', N'', N'', 1, N'', N'' ), 
...
VALUES  ( 100, 100, N'申请退培', N'retireTrainingDetails', N'editRetireTraining', N'iconicon-edit', N'' ),
        ...
        ( 210, 200, N'带教老师审核请假', N'leaveDetails', N'examineCommon', N'icon-shenhe', N'2天内' ),
        ( 220, 200, N'科室管理员审核请假', N'leaveDetails', N'examineCommon', N'icon-shenhe', N'5天内' ),
        ( 230, 200, N'医院管理员审核请假',  N'leaveDetails', N'examineCommon', N'icon-shenhe', N'' ),
        ( 300, 300, N'提交轮转登记手册', N'rotationDetails', N'editRotation', N'iconicon-edit', N'' ),
        ( 310, 300, N'带教老师审核轮转登记手册', N'rotationDetails', N'examineCommon', N'icon-shenhe', N'' ),
        ( 400, 400, N'出科申请', N'outDepartmentDetails', N'editOutDepartment', N'iconicon-edit', N'' ),
        ( 410, 400, N'科室管理员审核出科', N'outDepartmentDetails', N'examineCommon', N'icon-shenhe', N'' ),
        ( 420, 400, N'医院管理员审核出科', N'outDepartmentDetails', N'examineCommon', N'icon-shenhe', N'' ),
