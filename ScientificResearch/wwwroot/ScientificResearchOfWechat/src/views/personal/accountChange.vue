<template>
  <section class="box">
    <van-tabs v-model="active" swipeable class="popup">
      ...
      <van-tab title="人事信息">
        <van-cell-group>
          <van-field v-model="list.入职日期" label="入职日期" clearable/>
          <van-field v-model="list.人员类别" label="人员类别" clearable/>
          <van-field v-model="list.岗位性质" label="岗位性质" clearable/>
          <van-field v-model="list.岗位类型" label="岗位类型" clearable/>
          <van-field v-model="list.岗位名称" label="岗位名称" clearable/>
          <van-field v-model="list.合同开始日期" label="合同开始日期" clearable/>
          <van-field v-model="list.合同结束日期" label="合同结束日期" clearable/>
          <van-field v-model="list.参加工作时间" label="参加工作时间" clearable/>
        </van-cell-group>
      </van-tab>
