    ...
    <van-tabs v-model="active" swipeable>
      ...
      <van-tab title="相关文件">
        <ul class="servicel">
          ...
          <li>检索信息页相关文件路径：</li>
          <li>
            <a :href="this.detailslList.检索信息页相关文件路径" download>{{this.detailslList.检索信息页相关文件路径}}</a>
          </li>
          <h4>论文正文</h4>
          <li>论文正文：</li>
          <li>
            <a :href="this.detailslList.论文正文路径">{{this.detailslList.论文正文路径}}</a>
          </li>
          <h4>其他相关文件</h4>
          <li>其他相关文件：</li>
          <li>
            <a :href="this.detailslList.其他相关文件路径">{{this.detailslList.其他相关文件路径}}</a>
          </li>
        </ul>
      </van-tab>
      <van-tab title="审核记录">
