    ...
    avalon.ready(function () {
        window.vm = avalon.define({
            ...
            query: function () {
                vm.loaded = false;
                $.support.cors = true;
                ResearchProject.getYProjectAlterationList('get', vm.req.$model, function getYProjectAlterationListListener(success, obj, strErro) {
                    if (success) {
                        vm.loaded = true;
                        vm.total = obj.total;
            ...
            alterationDetails: function (el) {
                $('.modal-details .modal-title').text('变更详情');
            ...
            details: function (el) {
                ...
                $('.modal-details .detailsPage').attr('src', vm.getUrl('/IMIS/views/纵向项目/项目立项/纵向项目立项详情.html'));
