        ...
        window.vm = avalon.define({
            ...
            load: function () {
                if (xueShuDetails.id == null) {
                    ...
                    vm.getYProjectMiddleInspectionDetails(xueShuDetails.id);
                }
            },
            getYProjectMiddleInspectionDetails: function (id) {
                ResearchProject.getYProjectMiddleInspectionDetails('get', id, function getYProjectMiddleInspectionDetailsListener(success, obj, strErro) {
                    if (success) {
            ...
            Printing: function () {
                window.open('打印专家评审记录.html?type=0');
            },
