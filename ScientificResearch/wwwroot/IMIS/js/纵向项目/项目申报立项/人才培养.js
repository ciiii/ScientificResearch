    ...
    avalon.ready(function () {
        window.vm = avalon.define({
            ...
            query: function () {
                vm.loaded = false;
                $.support.cors = true;
                Declare.getYCanPersonnelDeclareList('get', vm.req.$model, function getYCanPersonnelDeclareListListener(success, obj, strErro) {
                    if (success) {
                        vm.loaded = true;
                        vm.total = obj.total;
                        ...
                        console.info('获取纵向项目人才培养可立项列表失败！');
            ...
            details: function (el) {
                ...
                sessionStorage.xueShuDetails = JSON.stringify(details);
                $('.modal-details .detailsPage').attr('src', vm.getUrl('/IMIS/views/纵向项目/项目申报/纵向项目申报详情.html'));
