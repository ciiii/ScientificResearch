    ...
    avalon.ready(function () {
        window.vm = avalon.define({
            ...
            query: function () {
                ...
                vm.hasData = false;
                $.support.cors = true;
                FruitStatistics.getPatentFruitStatisticsList('get', vm.req.$model, function getPatentFruitStatisticsListListener(success, obj, strErro) {
                    if (success) {
                        vm.loaded = true;
