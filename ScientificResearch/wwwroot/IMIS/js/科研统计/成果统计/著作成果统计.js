    ...
    avalon.ready(function () {
        window.vm = avalon.define({
            ...
            query: function () {
                ...
                vm.hasData = false;
                $.support.cors = true;
                FruitStatistics.getWorkFruitStatisticsList('get', vm.req.$model, function getWorkFruitStatisticsListListener(success, obj, strErro) {
                    if (success) {
                        vm.loaded = true;
                        vm.total = obj.length;
