    ...
    avalon.ready(function () {
        window.vm = avalon.define({
            ...
            query: function () {
                ...
                vm.hasData = false;
                $.support.cors = true;
                FruitStatistics.getEducationFruitStatisticsList('get', vm.req.$model, function getEducationFruitStatisticsListListener(success, obj, strErro) {
                    if (success) {
                        vm.loaded = true;
