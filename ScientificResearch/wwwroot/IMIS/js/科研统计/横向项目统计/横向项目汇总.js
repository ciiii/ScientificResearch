    ...
    avalon.ready(function () {
        window.vm = avalon.define({
            ...
            query: function () {
                vm.loaded = false;
                $.support.cors = true;
                XProjectStatistics.getXProjectSummary('get', vm.req.$model, function getXProjectSummaryListener(success, obj, strErro) {
                    if (success) {
                        vm.loaded = true;
                        vm.total = obj.total;
            ...
            details: function (el) {
                ...
                $('.modal-details .detailsPage').attr('src', vm.getUrl('/IMIS/views/科研统计/横向项目统计/横向项目汇总详情.html'));
            },
