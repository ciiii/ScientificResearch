$(function () {
    window.vm = null;
    if (sessionStorage.topInfo != null) {
        window.topInfo = JSON.parse(sessionStorage.topInfo);
    }
    window.mtopName = oa.getUrlParam('topName');
    avalon.ready(function () {
        window.vm = avalon.define({
            ...
            query: function () {
                vm.loaded = false;
                $.support.cors = true;
                Dictionary.getPagingDictionaryChild('get', vm.req.$model, function getPagingDictionaryChildListener(success, obj, strErro) {
                    if (success) {
                        vm.loaded = true;
                        vm.total = obj.total;
