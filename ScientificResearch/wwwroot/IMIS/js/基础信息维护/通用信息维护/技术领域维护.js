        ...
        window.vm = avalon.define({
            ...
            query: function () {
                ...
                function getUrl() {
                    ...
                    var url = encodeURI(encodeURI(Code.URL_GET_TECHNICAL_FIELD_LIST + param));
                ...
                function addHoverDom(treeId, treeNode) {
                    ...
                    if (btn) btn.bind("click", function () {
                        ...
                        vm.addTechnicalField(treeNode, data, name, zTree);
                    });
                };
            ...
            addTechnicalField: function (treeNode, data, name, zTree) {
                TechnicalField.addTechnicalField('post', data, function addTechnicalFieldListener(success, obj, strErro) {
                    if (success) {
                        var newNode = {
                            id: 0,
                            编号: 0,
            ...
            editTechnicalField: function (data) {
                TechnicalField.editTechnicalField('post', data, function editTechnicalFieldListener(success, obj, strErro) {
                    if (success) {
                        $.oaNotify.ok(' 修改成功！');
            ...
            confirmDel: function (arr) {
                console.info(arr);
                TechnicalField.delTechnicalField('post', arr.$model, function delTechnicalFieldListener(success, obj, strErro) {
                    var icon;
                    if (success) {
            ...
            delTechnicalField: function (arr) {
                TechnicalField.delTechnicalField('post', arr, function delTechnicalFieldListener(success, obj, strErro) {
                    if (success) {
                        $.oaNotify.ok('删除成功！');
                    } else {
