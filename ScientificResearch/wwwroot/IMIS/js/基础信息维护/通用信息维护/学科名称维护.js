        ...
        window.vm = avalon.define({
            ...
            query: function () {
                ...
                function getUrl() {
                    ...
                    var url = encodeURI(encodeURI(Code.URL_GET_SUBJECT_LIST + param));
                ...
                function addHoverDom(treeId, treeNode) {
                    ...
                    if (btn) btn.bind("click", function () {
                        ...
                        vm.addSubject(treeNode, data, name, zTree);
                    });
                };
            ...
            addSubject: function (treeNode, data, name, zTree) {
                Subject.addSubject('post', data, function addSubjectListener(success, obj, strErro) {
                    if (success) {
                        var newNode = {
                            id: 0,
                            编号: 0,
            ...
            editSubject: function (data) {
                Subject.editSubject('post', data, function editSubjectListener(success, obj, strErro) {
                    if (success) {
                        $.oaNotify.ok(' 修改成功！');
            ...
            confirmDel: function (arr) {
                console.info(arr);
                Subject.delSubject('post', arr.$model, function delSubjectListener(success, obj, strErro) {
                    var icon;
                    if (success) {
            ...
            delSubject: function (arr) {
                Subject.delSubject('post', arr, function delSubjectListener(success, obj, strErro) {
                    if (success) {
                        $.oaNotify.ok('删除成功！');
                    } else {
