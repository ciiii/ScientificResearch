        ...
        window.vm = avalon.define({
            ...
            query: function () {
                ...
                function getUrl() {
                    ...
                    var url = encodeURI(encodeURI(Code.URL_GET_CONTRACT_BUYER_LIST + param));
                ...
                function addHoverDom(treeId, treeNode) {
                    ...
                    if (btn) btn.bind("click", function () {
                        ...
                        vm.addContractBuyer(treeNode, data, name, zTree);
                    });
                };
            ...
            addContractBuyer: function (treeNode, data, name, zTree) {
                ContractBuyer.addContractBuyer('post', data, function addContractBuyerListener(success, obj, strErro) {
                    if (success) {
                        var newNode = {
                            id: 0,
                            编号: 0,
            ...
            editContractBuyer: function (data) {
                ContractBuyer.editContractBuyer('post', data, function editContractBuyerListener(success, obj, strErro) {
                    if (success) {
                        $.oaNotify.ok(' 修改成功！');
            ...
            confirmDel: function (arr) {
                console.info(arr);
                ContractBuyer.delContractBuyer('post', arr.$model, function delContractBuyerListener(success, obj, strErro) {
                    var icon;
                    if (success) {
            ...
            delContractBuyer: function (arr) {
                ContractBuyer.delContractBuyer('post', arr, function delContractBuyerListener(success, obj, strErro) {
                    if (success) {
                        $.oaNotify.ok('删除成功！');
                    } else {
