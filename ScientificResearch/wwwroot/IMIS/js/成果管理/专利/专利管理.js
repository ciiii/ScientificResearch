    ...
    avalon.ready(function () {
        window.vm = avalon.define({
            ...
            query: function () {
                vm.loaded = false;
                $.support.cors = true;
                Patent.getPatentList('get', vm.req.$model, function getPatentListListener(success, obj, strErro) {
                    if (success) {
                        vm.loaded = true;
                        vm.total = obj.total;
            ...
            search: function () {
                vm.req.Index = 1;
                vm.req.Like专利名称 = vm.title;
                vm.req.Like专利权人名称 = vm.patent;
                vm.req.Like第一发明人 = vm.name;
                vm.query();
            },
            submit: function () {
                if (event.keyCode == 13) {
