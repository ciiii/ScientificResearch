    ...
    avalon.ready(function () {
        window.vm = avalon.define({
            ...
            query: function () {
                vm.loaded = false;
                $.support.cors = true;
                ExpertTalents.getExpertTalentshUsers('get', vm.req.$model, function getExpertTalentshUsersListener(success, obj, strErro) {
                    if (success) {
                        vm.loaded = true;
                        vm.total = obj.total;
            ...
            clickBtnAdd: function () {
                sessionStorage.addUerType = JSON.stringify(1);
                var userType = {
                    type: false,
                    infoBack: true,
                    btnBack: false
            ...
            delUser: function (arr) {
                ExpertTalents.delExpertTalentsUsers('post', arr, function delExpertTalentsUsersListener(success, obj, strErro) {
