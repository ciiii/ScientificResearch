    ...
    avalon.ready(function () {
        window.vm = avalon.define({
            ...
            query: function () {
                vm.loaded = false;
                $.support.cors = true;
                FundsReimbursement.getHostLectureReimbursementList('get', id, function getHostLectureReimbursementListListener(success, obj, strErro) {
                    if (success) {
