  ...
  <div class="details">
    ...
    <div class="content">
      <el-table class="tableone" ref="multipleTable"
        ...
        <el-table-column align="center" label="往届应届" prop="往届应届"></el-table-column>
...
<script>
  import { URL_SETTING, HTTP_URL_HOST, URL_BASE_INFO, URL_ORGANIZATION } from '@/assets/js/connect/ConSysUrl';
