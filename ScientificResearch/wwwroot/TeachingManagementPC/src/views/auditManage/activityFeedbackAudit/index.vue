<template>
  <div class="app-container page-common">
    <h4 class="page-title" align="center">教学活动反馈审核</h4>
    ...
    <div class="content" v-if="list&&list.length>0">
      <el-table class="tableone" v-loading="listLoading" :data="list"
        ...
        <el-table-column label="教学本院策略" prop="教学本院策略名称" align="center"></el-table-column>
...
<script>
  import { HTTP_URL_HOST, URL_ACTIVITY, WORK_FLOW_STATE, URL_ORGANIZATION } from '@/assets/js/connect/ConSysUrl';
