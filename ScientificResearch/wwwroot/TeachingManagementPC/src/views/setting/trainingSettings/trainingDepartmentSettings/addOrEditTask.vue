  ...
  <div class="content-box">
    <el-form ref="form" :model="form" :rules="rules" label-width="130px" size="small">
      <el-form-item label="专业科室">
        <el-input disabled :value="title"></el-input>
      </el-form-item>
...
<script>
  ...
  export default {
    ...
    mounted() {
      ...
      this.title = this.info.教学专业名称 + '--' + this.info.科室名称;
      this.getTypes();
      this.getlevels();
    ...
    methods: {
      ...
      addEditTask: async function(data) {
        await this.$http.myPost(URL_SETTING.POST_ADD_EDIT_MAJOR_DEPARTMENT_TASK, data);
