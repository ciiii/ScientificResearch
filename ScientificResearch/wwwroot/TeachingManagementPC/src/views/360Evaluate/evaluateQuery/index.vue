  ...
  <div class="app-container page-common">
    ...
    <div class="filter-container">
      <div class="filter-item">
        评价方向
        <el-select v-model="direction" placeholder="请选择" @change="changeDirections" value-key="编号">
          <el-option v-for="item in directions" :key="item.编号" :label="item.名称" :value="item"></el-option>
        </el-select>
      </div>
      ...
      <el-input v-model="req.Like被评价人姓名" placeholder="被评价人姓名" style="width: 200px;" class="filter-item"
                @keyup.enter.native="onSearch" prefix-icon="el-icon-search"/>
