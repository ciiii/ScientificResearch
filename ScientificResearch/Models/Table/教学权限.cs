...
namespace ScientificResearch.Models
{
	...
	{       
		...
		/// 
		/// </summary>
        [MaxLength(100,ErrorMessage ="PC端组件名不能超过[50]字")]
		public string PC端组件名 { get; set; }
        /// <summary>
		/// 
		/// </summary>
        [MaxLength(100,ErrorMessage ="移动端组件名不能超过[50]字")]
		public string 移动端组件名 { get; set; }
        /// <summary>
		/// 不是菜单就是按钮之类的;
		/// </summary>
        [DisplayName("不是菜单就是按钮之类的;")]
