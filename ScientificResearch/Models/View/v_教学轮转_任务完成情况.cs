...
namespace ScientificResearch.Models
{
    ...
    /// </summary>
    [Serializable]
	public partial class v_教学轮转_任务完成情况 
	{       
		...
		/// 
		/// </summary>
        public int? 已完成技能病例数 { get; set; }
        /// <summary>
		/// 
		/// </summary>
        public int? 已完成疾病病例数 { get; set; }
        /// <summary>
		/// 
		/// </summary>
        public int? 已完成门诊病例数 { get; set; }
        /// <summary>
		/// 
		/// </summary>
        public int? 已完成病房病例数 { get; set; }
        /// <summary>
		/// 
		/// </summary>
        public int? 已完成医技病例数 { get; set; }
